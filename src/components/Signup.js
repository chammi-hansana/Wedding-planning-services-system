        ...
        <div style={{ fontSize: '15px' }}>
          <Form.Group className="mb-2" controlId="exampleForm.ControlInput1">
            ...
            <div style={{ textAlign: "left", fontSize: '18px' }}>
              Already registered <a href="/" > Login </a></div>

            <Button style={{ width: "380px", height: "50px", fontSize: '19px', textAlign: "center", padding: "10px 55px", margin: "70px 30px 10px 50px",backgroundColor:"#dba96d",borderColor:"#dba96d" ,color:"#dba96d"}}
              className="mt-3"
          ...
          >
              <a href="/" style={{color:"white",}}> Signup </a></div>
            </Button>{" "}
          </Form.Group>
        </div>
      </Form>
